...
router.get("/google/callback", auth_middleware_1.requireAuth, integrations_controller_1.integrationsController.handleGoogleCallback.bind(integrations_controller_1.integrationsController));
